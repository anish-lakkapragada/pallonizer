...
On every single run, 
check all images 
add the source to all of them with no we-added property 
if no src attribute, just add one and add the we -added property 
then remove all of the wacky weird data stuff and srcset
...
// also add an event listener for any items that will be changed. 
